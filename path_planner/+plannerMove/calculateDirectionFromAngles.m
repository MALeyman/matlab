...
function robotNewDir = calculateDirectionFromAngles(robotDir, azimuthAngle, elevationAngleDiff, movementSelection, numSectors)
    ...
    % Если прохода нет, движемся горизонтально вправо
